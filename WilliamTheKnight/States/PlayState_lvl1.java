...
public class PlayState_lvl1 extends PlayState{
    public PlayState_lvl1(RefLinks refLink)
    {
        ...
        refLink.SetMap(map);
        ///Construieste eroul
        hero = new Hero(refLink,0, 0, 80, 75);
    ...
    public void Draw(Graphics g) {
        BufferedImage backgroundul = ImageLoader.LoadImage("/Sprites joc William/Background1.png");
