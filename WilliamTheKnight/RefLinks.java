...
import WilliamTheKnight.Items.CollisionChecker;
...
public class RefLinks
{
    ...
    private static RefLinks instance; //INSTANTA JOCULUI

    public CollisionChecker colli = new CollisionChecker(this);
    ...
    //SINGLETON !!! :
    public static RefLinks getInstance(Game game)
    {
        if (instance == null) {
            instance = new RefLinks(game);
        }
        return instance;
    }
