...
public abstract class Character extends Item
{
    ...
    //urmatoarele erau "static final", dar le-am modificat, ca aveam si alte marimi.
    public static int DEFAULT_CREATURE_WIDTH  = 48;   /*!< Latimea implicita a imaginii caracterului.*/
    public static int DEFAULT_CREATURE_HEIGHT = 48;   /*!< Inaltimea implicita a imaginii caracterului.*/
     ...
     */
    public Character(RefLinks refLink, float x, float y, int width, int height) //Constructor de initializare
    {
