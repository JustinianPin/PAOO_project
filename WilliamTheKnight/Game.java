...
import WilliamTheKnight.GameWindow.GameWindow;
import WilliamTheKnight.Graphics.Assets;
import WilliamTheKnight.Input.KeyManager;
import WilliamTheKnight.Items.Camera;
import WilliamTheKnight.States.*;
...
public class Game implements Runnable
{
    ...
    private PlayState playState3;   /*!< Referinta catre joc.*/
    ...
    {
        /// Obiectul GameWindow este creat insa fereastra nu este construita, ESTE DOAR JFrame
    ...
    private void InitGame()
    {
        ...
        //BufferedImage background = ImageLoader.LoadImage("/Sprites joc William/Background1.png");

        //Image backgroundul = ImageLoader.LoadImage("/Sprites joc William/Background1.png");
        //Image backgroundul = ImageLoader.LoadImage((BufferedImage) ImageLoader.LoadImage("/Sprites joc William/Background1.png"));
        //(ImageLoader.LoadImage("/Sprites joc William/Background1.png"));
        //g.drawImage(backg, 0, 0, 960,480, null);

        ///     SA VAD: modific corespunzator la width si height cu parametrii.

        /*
        //SpriteSheet backgroundul = new SpriteSheet(ImageLoader.LoadImage("/Sprites joc William/Background1.png"));
        BufferedImage backg = ImageLoader.LoadImage("/Sprites joc William/Background1.png");
        //Image backgroundul = ImageLoader.LoadImage("/Sprites joc William/Background1.png");
        //Image backgroundul = ImageLoader.LoadImage((BufferedImage) ImageLoader.LoadImage("/Sprites joc William/Background1.png"));
                //(ImageLoader.LoadImage("/Sprites joc William/Background1.png"));
        g.drawImage(backg, 0, 0, 960,480, null);
       ...
       /* BufferedImage backg = ImageLoader.LoadImage("/Sprites joc William/Background1.png");
        g.drawImage(backg, 0, 0, 960,480, g);
        */
        ...
        playState1       = new PlayState_lvl1(refLink);
        playState2       = new PlayState_lvl2(refLink);
        playState3       = new PlayState_lvl3(refLink);
    ...
    public void setPlayState(int id) {
        switch (id) {
            case 1:
                this.id = id;
                refLink.SetMap(playState1.getMap());
                State.SetState(playState1);
                break;
            case 2:
                this.id = id;
                refLink.SetMap(playState2.getMap());
                State.SetState(playState2);
                break;
            case 3:
                this.id = id;
                refLink.SetMap(playState3.getMap());
   ...
   /// public PlayState GetPlayState() { return playState;}
    ...
    public PlayState GetPlayState() {
        return (PlayState_lvl1) playState1;
    }
}
